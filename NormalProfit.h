...
public:
	...
	void setBotToken(){
		...
		(goldSellPrice - botPrice) > gameTimeSellPrice ? std::cout << " The best Option for selling gold is : " << (goldSellPrice - botPrice) << " T (GOLD) \n" : std::cout << " The bets obtion for selling gold is: " << gameTimeSellPrice << " T (GAME TIME x60)\n";
		std::cout << "\n\n ****************************************\n\n";
